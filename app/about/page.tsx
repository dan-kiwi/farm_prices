    ...
    <div className="flex flex-col">
      <div className="max-w-3xl gap-2">
        ...
        <div className="mantine-Text-root mantine-1d564l0 mb-4">
          ...
          farmers and agricultural enthusiasts, providing essential pricing
        ...
        <div className="mantine-Text-root mantine-1d564l0 mb-4">
          ...
          feedback and encourage you to share your suggestions and ideas for
        ...
        <div className="mantine-Text-root mantine-1d564l0 mb-8">
          ...
          that continues to thrive and provide exceptional value to farmers
          worldwide.
        </div>
      </div>
      <ContactUs />
